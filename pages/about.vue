  ...
  <div>
    ...
    <Container class="mt-16 sm:mt-32">
      ...
      >
        ...
        <div class="lg:pl-20">
          <ul role="list">
            <SocialLink href="#" :icon="IconTwitter">
              Follow on Twitter
            </SocialLink>
            <SocialLink href="#" :icon="IconInstagram" class="mt-4">
              Follow on Instagram
            </SocialLink>
            <SocialLink href="#" :icon="IconGithub" class="mt-4">
              Follow on GitHub
            </SocialLink>
            <SocialLink href="#" :icon="IconLinkedin" class="mt-4">
              Follow on LinkedIn
            </SocialLink>
            <SocialLink
